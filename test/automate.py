...
def CoderpadAutomation(mode):
    ...
    if(mode == "caller"):
        time.sleep(0.25)
        name_field = (515, 497)
        pyautogui.click(name_field[0], name_field[1]); pyautogui.typewrite('Stegozoa1'); pyautogui.typewrite(['enter'])
        ...
        time.sleep(0.25)
        name_field = (515, 497)
        pyautogui.click(name_field[0], name_field[1]); pyautogui.typewrite('Stegozoa2'); pyautogui.typewrite(['enter'])
